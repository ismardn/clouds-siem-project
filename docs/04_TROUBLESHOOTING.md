...
* **La solution :** Mise à jour globale du cluster. Déverrouillage des paquets (`apt-mark unhold`) et mise à niveau séquentielle de l'Indexer, du Manager et du Dashboard via `apt-get install --only-upgrade`.
